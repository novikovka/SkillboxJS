...
grid.getRandomEmptyCell().linkTile(new Tile(gameBoard)); //я так понимаю, что вот тут создается новая ячейка
...
function slideTilesInGroup(group){
    for(let i = 1; i<group.length; i++) {
        ...
        let targetCell;
        let j = i-1; //счетчик (индекс ячейки которая выше той которую сейчас рассматриваем)
